  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center px-6">
      <div className="w-full max-w-md bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl p-8">
        <h1 className="text-xl font-bold text-[var(--text-primary)] mb-4">Change Password</h1>
        ...
        <form action={changePasswordAction} className="space-y-4">
          <input
            ...
            className="w-full p-2 bg-black border border-gray-700 text-[var(--text-primary)] rounded"
          />
          <input
            name="confirm"
            type="password"
            ...
            className="w-full p-2 bg-black border border-gray-700 text-[var(--text-primary)] rounded"
          />
          <button className="w-full bg-indigo-600 py-2 rounded text-[var(--text-primary)]">
            Save
          </button>
        </form>
      </div>

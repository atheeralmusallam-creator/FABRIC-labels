  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)]">
      <main className="max-w-3xl mx-auto px-6 py-10 space-y-6">
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">Create Project</h1>

        <input
          value={name}
          onChange={(e) => setName(e.target.value)}
          placeholder="Project name"
          className="w-full p-3 bg-[var(--bg-secondary)] border border-[var(--border)] rounded-lg text-[var(--text-primary)]"
        />
        ...
        {/* 🔥 checkbox الجديد */}
        <label className="flex items-start gap-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border)] p-4">
          <input
            type="checkbox"

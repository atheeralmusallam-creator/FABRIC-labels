  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 fade-in">
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-5">
        <p className="text-sm text-[var(--text-secondary)] mb-3 font-medium uppercase tracking-wide">Text</p>
        <p className="text-base text-[var(--text-primary)] leading-relaxed">{data.text}</p>
      </div>

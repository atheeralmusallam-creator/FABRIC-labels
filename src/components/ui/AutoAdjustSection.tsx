        ...
        <div className="flex items-center gap-2">
          ...
          {disagreedTasks.length > 0 && (
            <button
              ...
              className="text-xs px-4 py-2 rounded-lg transition-all disabled:opacity-50 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-[var(--text-primary)] font-medium shadow-md shadow-amber-500/20"
            >

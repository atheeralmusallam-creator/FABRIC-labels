...
export function EditProjectButton({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center px-4">
      <div className="w-full max-w-lg bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-5 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-[var(--bg-primary)] border border-[var(--border)] rounded-lg px-3 py-2 text-sm text-[var(--text-primary)] outline-none focus:border-indigo-500"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-[var(--bg-primary)] border border-[var(--border)] rounded-lg px-3 py-2 text-sm text-[var(--text-primary)] outline-none focus:border-indigo-500 resize-none"
          />
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-xs text-[var(--text-muted)]">Annotators</label>
          ...
          <input
            ...
            className="w-full mb-2 bg-[var(--bg-primary)] border border-[var(--border)] rounded-lg px-3 py-2 text-sm text-[var(--text-primary)] outline-none focus:border-indigo-500"
          />

          <div className="max-h-48 overflow-y-auto bg-[var(--bg-primary)] border border-[var(--border)] rounded-lg p-2 space-y-1">
            {loadingAnnotators ? (
              ...
              filteredAnnotators.map((user) => (
                <label
                  key={user.id}
                  className="flex items-center gap-2 px-2 py-2 rounded hover:bg-[var(--bg-surface)] cursor-pointer"
                >
                  <input
                    type="checkbox"
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            className="text-sm px-4 py-2 rounded-lg bg-[var(--bg-surface)] text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
          >
            Cancel
          </button>
          ...
          <button
            onClick={save}
            disabled={saving}
            className="text-sm px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-[var(--text-primary)]"
          >
            {saving ? "Saving..." : "Save"}
          </button>
        </div>
